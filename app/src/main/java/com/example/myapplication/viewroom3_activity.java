...
public class viewroom3_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_viewroom3);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(viewroom3_activity.this, payment_activity.class);
