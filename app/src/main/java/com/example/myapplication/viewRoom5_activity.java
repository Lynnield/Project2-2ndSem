...
public class viewRoom5_activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_view_room5);
        ...
        bookNowButton.setOnClickListener(v -> {
            Intent intent = new Intent(viewRoom5_activity.this, payment_activity.class);
